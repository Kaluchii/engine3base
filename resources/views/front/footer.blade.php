        ...
        <div class="bottom-row">
            ...
            <p class="bottom-text center">Комплекс в социальных сетях:<br>
                <span class="soc-links">
                    <a href="{{$static->vk_field}}" rel="nofollow" target="_blank" class="link">ВКонтакте</a>
                    <a href="{{$static->inst_field}}" rel="nofollow" target="_blank" class="link">Инстаграм</a>
                    <a href="{{$static->fb_field}}" rel="nofollow" target="_blank" class="link">Фейсбук</a>
                </span>
            </p>
