                        ...
                        <div class="input-group file-caption-main">
                            ...
                            <div class="file-preview-frame">
                                <div class="kv-file-content">
                                    <img src="{{$item->place_photo_field->link}}" class="kv-preview-data file-preview-image" title="{{$item->place_photo_field->alt}}" alt="{{$item->place_photo_field->alt}}" style="width:auto;height:160px;">
                                </div>
                                <div class="file-thumbnail-footer">
                                    <div class="file-footer-caption" title="{{$item->place_photo_field->alt}}">{{$item->place_photo_field->name_field}} <br><samp>(425.24 KB)</samp></div>
