<div class="box">
    <div class="box-header with-border">
        ...
        <button type="submit" class="btn btn-primary pull-right remove-flat-item" data-id="{{$item->id_field}}"
                data-block="slider_from">Удалить</button>
    </div>
    <div class="box-body">
                        ...
                        <div class="input-group file-caption-main">
                            ...
                            <div class="file-preview-frame">
                                <div class="kv-file-content">
                                    <img src="{{$item->slide_field->link}}" class="kv-preview-data file-preview-image" title="{{$item->slide_field->alt}}" alt="{{$item->slide_field->alt}}">
                                </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text"
                      data-name="slide_text"
                      data-type="text"
                      data-block="slider_from"
                      data-id="{{$item->id_field}}">{{$item->slide_text_field}}</textarea>
        </div>
